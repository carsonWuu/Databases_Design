package com.rs.device.update.setting;
 ...
 *
 */
public class StrangerSetting extends HttpServlet{
	...
	public void doGet(HttpServletRequest request,
	 ...
	 public void doPost(HttpServletRequest request,
	  ...
	  private void process(HttpServletRequest req, HttpServletResponse resp) throws Exception{
			...
			int line  = UserDaoImpl.device_setstrangerinfo(reqBean);
			 ...
			 * 
{
	...
	"token": "7a57a5a743894a0e"
			...
			if(line != 0) {//查找有内容
				...
				map.put("deviceid",reqBean.getAnti_stranger_status());
			}
			else {
				res.setResult(-1);
			}
